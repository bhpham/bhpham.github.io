...
<html lang="en">
    <head>
        ...
        <title>Bill Pham Portfolio</title>
    </head>
    <body>
                ...
                <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Bill Pham</a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 wow bounceInUp">
                            <div class="profile-item">
                                ...
                                <h5><a href="https://calendar.app.google/dR2K8XFKsoSwPd9J7">Schedule a call</a></h5>
                            </div>
                        </div>
            ...
            <section class="section-skills js--section-skills" id="skills">
                <div class="container">
                    <div class="row">
                        ...
                        <p class="long-copy">Technology professional with 7 years experience in consulting, managing and executing challenging projects in various roles - Software Engineer, Consultant, Project Manager, Architect, Technical Account Manager, Solutions consultant.</p>
                    </div>
                    <div class="row js--wp-1">
                        <div class="col-sm-3 wow">
                            <i class="fa fa-cloud icon-big"></i>
                            <h4>Cloud Computing</h4>
                            <p>Leverage Google/AWS Cloud services, I would eliminate up-front capital infastructure costs that, in turn, help scale up your business and easily access thousands of servers virtually within minutes.</p>
                        </div>
                        <div class="col-sm-3 wow">
                            <i class="fa fa-tasks icon-big"></i> 
                            <h4>Project Management</h4>
                            <p>Provides leadership in the establishment and development of projet base line budgets, resource allocation, and schedules helping team to scale fast.</p>
                        </div>
                        <div class="col-sm-3 wow">
                            <i class="fa fa-desktop icon-big"></i>
                            <h4>Mobile/Web App Developer</h4>
                         ...
                         <div class="col-sm-3 wow">
                            <i class="fa fa-pie-chart icon-big"></i>
                            <h4>Data Analytics</h4>
                            <p>I help to collect, transform, and organize data in order to draw conclusions, make predictions, consult, and drive informed decision making to business strategy. Let's talk!</p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 wow bounceInUp">
                            <div class="profile-widget">
                                ...
                                <h5>Google / AWS Cloud Computing Services</h5>
                                <div class="skill-bar">
                                    <div class="skill-rate-on"></div>
                                    <div class="skill-rate-on"></div>
                                    <div class="skill-rate-on"></div>
                                ...
                                <h5>J2EE Spring MVC / RESTful / Hibernate</h5>
                                <div class="skill-bar">
                                    <div class="skill-rate-on"></div>
                                    <div class="skill-rate-on"></div>
                                    <div class="skill-rate-on"></div>
                            ...
                            <div class="profile-widget">
                                ...
                                <ul class="cert-icons">
                                    <a href="https://www.credential.net/08a430b6-853c-4971-aa86-4e2954991f7b"><li><img src="resources/img/GCPA_cloudArchitect_badge.png"></li></a>
                                    <a href="https://google.accredible.com/5683994e-d1a4-4478-9c0e-87fd6453709e"><li><img src="resources/img/GCPA_dataEngineer_badge.png"></li></a>
                        ...
                        <div class="col-md-6 col-sm-12 wow bounceInRight">
                            ...
                            <div class="about">    
                                ...
                                <p>Specialties:
                                    ...
                                    <li>Data-driven and decision making</li>
                    ...
                    <div class="row">
                        ...
                        <div class="center-txt">
                            <div class="col-md-12 wow bounceInDown">
                                ...
                                <a href="http://bhpham.com/#" class="btn btn-ghost"><i class="fa fa-paper-plane-o icon-before"></i> Dive deeper into my brain</a>
                            </div>
                        </div>
                            ...
                            <a href="#" class="pop-up" title="Caption 3">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-item-description">
                                        ...
                                        <p>Global Steel Trader in Taiwan & Vietnam (Tech stack: PHP, Wordpress CMS, MySQL, JS, AWS services)</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="#" class="pop-up" title="Caption 4">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-item-description">
                                        ...
                                        <p>Japanese Beauty Online Store (Tech stack: PHP, Wordpress CMS, MySQL, AWS)</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="#" class="pop-up" title="Caption 2">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-item-description">
                                        ...
                                        <p>Logistic Startup in Dallas, US (Tech stack: Java, MySQL, JS, Oracle, AWS)</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="#" class="pop-up" title="Caption 3">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-item-description">
                                        ...
                                        <p>Interior E-commerce provider in Kirkland, WA (Tech stack: Java, MySQL, JS, Oracle, AWS)</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="#" class="pop-up" title="Caption 3">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-item-description">
                                        ...
                                        <p>Trading bikes e-commerce store (Tech stack: PHP, MySQL, JS, Oracle, AWS)</p>
                                    </div>
                                </div>
                            </a>
                        </div>
            ...
            <footer id="footer">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="copy">
                                Copyright &copy; 2015 Bill Pham. All Rights reserved.    
                            </p>
