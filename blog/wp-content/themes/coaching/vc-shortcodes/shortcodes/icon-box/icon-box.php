...
function thim_shortcode_icon_box( $atts ) {
	...
	$instance = array(
		...
		'desc_group' => array(
			...
			'custom_font_weight_desc' => $icon_box['custom_font_weight_desc'],
			'color_description'       => $icon_box['color_desc'],
			'description_mg_top'      => $icon_box['description_mg_top'],
		),

		'read_more_group' => array(
			'link'                   => $icon_box['read_more_link'],
			'read_more'              => $icon_box['read_more_link_to'],
			'link_target'            => $icon_box['read_more_target'],
		...
		'layout_group'        => array(
			...
			'sub_title_push' => $icon_box['layout_sub_title_push'],
			'img_push'       => $icon_box['layout_img_push'],
		...
		'icon_img_background' => $icon_box['icon_img_background'],
	...
	ob_start();
	if ( $icon_box['el_class'] ) {
		echo '<div class="' . $icon_box['el_class'] . '">';
	}
