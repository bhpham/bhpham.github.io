...
<h3 class="title"><?php _e( 'Your order', 'coaching' ) ?></h3>
...
<table class="learn-press-checkout-review-order-table lp-list-table">
    ...
    <tr>
        ...
        <th class="course-name"><?php _e( 'Course', 'coaching' ); ?></th>
        <th class="course-total"><?php _e( 'Total', 'coaching' ); ?></th>
    ...
    <tr class="cart-subtotal">
        ...
        <th><?php _e( 'Subtotal', 'coaching' ); ?></th>
