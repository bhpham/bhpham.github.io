    ...
    <div class="thim-course-top switch-layout-container">
        ...
        <div class="courses-searching">
            <form method="get" action="<?php echo esc_url( get_post_type_archive_link( 'lp_course' ) ); ?>">
                <input type="text" value="" name="s" placeholder="<?php esc_attr_e( 'Search our courses', 'coaching' ) ?>" class="form-control course-search-filter" autocomplete="off" />
...
<?php else: ?>
    ...
    <?php if( have_posts() ) {?>
        ...
        <div id="thim-course-archive"
             class="<?php echo ( $layout == 'list-layout' ) ? 'thim-course-list' : 'thim-course-grid'; ?>"
