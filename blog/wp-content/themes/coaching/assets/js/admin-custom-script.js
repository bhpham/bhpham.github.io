jQuery(function ($) {
    $(document).ready(function () {
        ...
        thim_coaching_install_demo();

        thim_coaching_30_install_demo();

        thim_coaching_edit_term();
    ...
    function thim_coaching_30_install_demo() {
    ...
    function thim_coaching_install_demo() {
    ...
    function thim_coaching_edit_term() {
