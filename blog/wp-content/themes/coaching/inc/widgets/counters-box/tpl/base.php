...
wp_enqueue_script( 'thim-counters-box.js', THIM_URI . 'inc/widgets/counters-box/js/counters-box.js', array( 'jquery','thim-waypoints' ), '', true );
...
if( $counter_style == 'home-effective' ) {
