...
add_action( 'admin_init', 'thim_coaching_check_need_upgrade_from_2x', 100 );

function thim_coaching_check_need_upgrade_from_2x() {
	$detect = get_site_transient( '_thim_coaching_need_upgrade' );
...
function thim_auto_compile_sass_to_css() {
	...
	delete_site_transient( '_thim_coaching_need_upgrade' );
...
if ( ! function_exists( 'thim_activation_thim_core' ) ) {
	function thim_activation_thim_core() {
		$thim_framework = new Thim_Plugin('thim-framework');
		$thim_framework->deactivate();

		set_site_transient( '_thim_coaching_need_upgrade', true, 7200 );
	}
}
...
/**
 * Update theme_mods_coaching when update to version 3.0
 */
if ( ! function_exists( 'thim_auto_updated_theme_mods_30' ) ) {
	function thim_auto_updated_theme_mods_30() {
		...
		$thim_font_body_font_family          = ! empty( $thim_font_body['font-family'] ) ? $thim_font_body['font-family'] : 'Open Sans';
		...
		$thim_font_title_font_family = ! empty( $thim_font_title['font-family'] ) ? $thim_font_title['font-family'] : 'Montserrat';
