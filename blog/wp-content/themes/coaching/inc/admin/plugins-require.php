	...
	function thim_get_all_plugins_require( $plugins ) {
		$plugins = array(
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-certificates.zip',
				'premium' => true,
				'required'    => false,
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-collections.zip',
				'required'    => false,
				'premium' => true,
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-paid-membership-pro.zip',
				'required'    => false,
				'premium' => true,
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-co-instructor.zip',
				'required'    => false,
				'premium' => true,
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/wp-events-manager-woo-payment.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '2.2',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-woo-payment.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-authorizenet-payment.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-coming-soon-courses.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-commission.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-content-drip.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-gradebook.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-mycred.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-random-quiz.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-stripe.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-sorting-choice.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				//'source'      => 'https://plugins.thimpress.com/downloads/coaching-plugins/learnpress-students-list.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '3.0',
			...
			array(
				...
				'premium' => true,
				'version'     => '1.1',
				'description' => 'Generate Pricing Table Plus in the easitest and dynamic way',
			),
			...
			array(
				'name'        => 'Coaching Demo Data',
				'slug'        => 'coaching-demo-data',
				//'source'      => 'https://thimpresswp.github.io/demo-data/coaching/coaching-demo-data.zip',
				'required'    => false,
				'premium' => true,
				'version'     => '1.2.0',
